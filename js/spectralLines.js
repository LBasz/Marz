...
SpectralLines.prototype.initialiseDefault = function() {
    ...
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2249,      0, 2, 1, 'shift+12'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2260,      0, 2, 1, 'shift+11'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2344,      0, 2, 1, 'shift+7'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2374,      0, 2, 1, 'shift+4'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2382,      0, 2, 1, 'shift+1'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2586,      0, 2, 1, 'shift+2'); // ADDED BY EFK
    this.addSpectralLine('Fe2', 'FeII', 'Iron 2',            2600,      0, 2, 1, 'shift+3'); // ADDED BY EFK
    this.addSpectralLine('Mn2', 'MnII', 'Manganese 2',       2606,      0, 2, 1, 'shift+13'); // ADDED BY EFK
    this.addSpectralLine('Mn2', 'MnII', 'Manganese 2',       2594,      0, 2, 1, 'shift+14'); // ADDED BY EFK
    this.addSpectralLine('Mn2', 'MnII', 'Manganese 2',       2576,      0, 2, 1, 'shift+15'); // ADDED BY EFK
